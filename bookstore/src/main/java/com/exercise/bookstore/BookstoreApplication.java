...
public class BookstoreApplication {
	...
	public CommandLineRunner bookstoreDemo(BookRepository repository, CategoryRepository drepository,
		...
		return (args) -> {
			...
			// "9780316769488", 8.99, category1));
			// repository.save(new Book("To Kill a Mockingbird", "Harper Lee", 1960,
			// "9780060935467", 7.19, category2));
			// repository.save(new Book("1984", "George Orwell", 1949, "9780451524935",
			// 9.99, category1));
			// repository.save(new Book("Moby Dick", "Herman Melville", 1851,
			// "9781503280786", 11.49, category3));
			// repository.save(new Book("Pride and Prejudice", "Jane Austen", 1813,
			// "9781503290563", 6.99, category2));

			AppUser user1 = new AppUser("user", "$2y$10$qJiIaSzLDCnsEFP6JLkkXuqjJnBcB6RqkIfes2fhIoCOsLIwhEBYC", "USER");
			AppUser user2 = new AppUser("admin", "$2y$10$swotAl9bzpLK4RuU2q1kIeEsXvH2zVjB09eZcnkNWw6fpb/Ik1BwW",
					"ADMIN");
